...
class appDevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        // my_web_site_homepage
        if (rtrim($pathinfo, '/') === '') {
            if (!in_array($this->context->getMethod(), array('GET', 'POST', 'HEAD'))) {
                $allow = array_merge($allow, array('GET', 'POST', 'HEAD'));
                goto not_my_web_site_homepage;
            }

            if (substr($pathinfo, -1) !== '/') {
                return $this->redirect($pathinfo.'/', 'my_web_site_homepage');
            }

            return array (  '_controller' => 'MyWeb\\SiteBundle\\Controller\\PageController::indexAction',  '_route' => 'my_web_site_homepage',);
        }
        not_my_web_site_homepage:
